                            ...
                            <table class="cart-table table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#"><img src="{{ asset('assets/img/shop/1.png')}}" alt="" height="90" width="90"></a>
                                        </td>
                                        <td>
                                            <a href="#">Delicious Food Name</a>
                                        </td>
                                        <td>
                                        ...
                                        <td colspan="6" class="actions">
                                            ...
                                            <div class="col-md-6">
                                                <div class="cart-btn">
                                                    ...
                                                    <button class="btn btn-success" type="submit" onclick="window.open('{{ route('shop_cart')}}', '_self')">Order Now</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
